...
const UserResponseContainer = (): React.JSX.Element => {
  return (
    <View style={styles.userResponseContainer}>
      ...
      <View style={styles.userResponseTxtContainer}>
        <Text style={styles.userResponseTxt}>
          <Text style={styles.userResponseTxtOranged} >This is an incorrect sentence.</Text> This is a user response.
          This is a user response.<Text style={styles.userResponseTxtOranged}> This is also incorrect.</Text>
        </Text>
